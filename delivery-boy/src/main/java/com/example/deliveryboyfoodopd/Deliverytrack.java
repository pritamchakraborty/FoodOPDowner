...
public class Deliverytrack extends AppCompatActivity implements OnMapReadyCallback, MapboxMap.OnMapClickListener, PermissionsListener {
    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        ...
        mapboxMap.setStyle(getString(R.string.navigation_guidance_day), new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                mapboxMap.addOnMapClickListener(Deliverytrack.this);
...
// Call this method with Context from within an Activity
                            NavigationLauncher.startNavigation(Deliverytrack.this, options);
                        }
                        catch (NullPointerException e)
                        {
                            e.printStackTrace();
